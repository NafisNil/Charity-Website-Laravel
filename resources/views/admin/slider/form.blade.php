...
<div class="card-body">
    ...
    <div class="form-group row">
      ...
      <div class="form-group">
        <label for="exampleInputEmail1">Subtitle <span style="color:red" >*</span></label>
    
        <textarea name="subtitle" id="" cols="30" rows="5" class="form-control">{!!old('subtitle',@$edit->subtitle)!!}</textarea>
